...
<section>
	<div class="container-fluid">
		...
		<table class="table table-bordered table-striped my-5 text-center table-sm" style="max-width: 500px">
			<?php $result = mysqli_query($conn, "SELECT * FROM scores where Student_Class = 'jss1 a' ORDER BY Name ASC") or die(mysqli_error($conn));?>
			<thead>
				<tr>
